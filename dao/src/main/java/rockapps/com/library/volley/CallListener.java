...
public abstract class CallListener<E, T extends JsonMessage> implements ErrorListener, Listener<JSONObject>, VolleyOnPreExecute {
    ...
    public CallListener(Context context, Class<E> type, Boolean saveLocal, String saveLocalName) {
        this();
    ...
    public CallListener(Activity activity, Class<E> type, String message, Boolean saveLocal, String saveLocalName) {
        this();
        this.activity = activity;
        if (message != null) {
            dialog = new ProgressDialog(activity);
